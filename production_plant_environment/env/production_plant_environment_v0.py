...
class ProductionPlantEnvironment():
    ...
    def _internal_step(self, action, action_selected_by_algorithm = False):
        ...
        self.trajectory.append(({'step': self.current_step, 'old_state': self.old_state, 'action': action, 'reward': reward, 'new_state': self.new_state, 'action_selected_by_algorithm': action_selected_by_algorithm}))
